...
class CorpusWatcher extends EventEmitter {
   ...
   * @param {import('../index').CorpusOptions} options
   */
  constructor(toplevel, options) {
    ...
    this.#sharedHandler = wrap(this.#sharedHandler, 'shred');
    this.#moveHandler = wrap(this.#moveHandler, 'move');
    this.#delayHandler = wrap(this.#delayHandler, 'delay');
 ...
 * @param {string} toplevel
 * @param {import('../index').CorpusOptions=} options
 * @return {import('../index').CorpusWatcher}
 */
